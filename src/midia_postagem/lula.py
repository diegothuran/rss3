...
link = 'https://lula.com.br/'


# In[3]:


link_site = 'https://lula.com.br'
...
noticias = BeautifulSoup(req.text, "html.parser").find_all('div', class_='card large card-medium')
noticias += BeautifulSoup(req.text, "html.parser").find_all('div', class_='card card-small')
noticias += BeautifulSoup(req.text, "html.parser").find_all('div', class_='card card-xsmall')
