...
link_site = 'https://www.gazetaesportiva.com'
...
noticias = BeautifulSoup(req.text, "html.parser").find_all('div', class_='main-heading post-standard post-type-post')
noticias += BeautifulSoup(req.text, "html.parser").find_all('div', class_='text')
noticias = BeautifulSoup(req.text, "html.parser").find_all('div', class_='name')
