...
soup = BeautifulSoup(req.text, "html.parser").find_all('div', class_='isoGrid-item')

for div in soup:
    page_link = 'http://agenciabrasil.ebc.com.br' + div.find('h3', class_= 'heading').find_all('a', href=True)[0]['href']
