...
link = 'http://www.blogdomagno.com.br/index.php'


# In[3]:


link_site = 'http://www.blogdomagno.com.br/'
...
noticias = BeautifulSoup(req.text, "html.parser").find_all('h2', class_='blog-post-title')
